...
const BlogGrid2 = () => {
  ...
  useEffect(() => {
    fetch('https://your-wordpress-site.com/wp-json/wp/v2/posts?per_page=3')
            ...
            {posts.map(post => (
              <div key={post.id} className="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
                <div className="flex items-center">
                  <img src={post.featured_media_src_url || 'default-image-url.jpg'} alt={post.title.rendered} className="rounded-t-2xl w-full" />
                </div>
