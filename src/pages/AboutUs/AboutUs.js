...
const AboutUs = () => {
        ...
        <div class="lg:pl-[100px] flex items-center">
          <div class="data w-full">
            ...
            <p class="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
              ...
              to empower creators, designers, and developers alike. Our mission is to provide a comprehensive toolkit,
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center gap-10 justify-center">
        <button id="slider-button-left"
          class="slider-button group p-2 transition-all duration-500 rounded-full hover:bg-indigo-600 lg:flex"
          data-carousel-prev="">
        ...
        <button id="slider-button-right"
          class="slider-button group transition-all p-2 duration-500 rounded-full hover:bg-indigo-600 lg:flex"
          data-carousel-next="">
          <svg class="w-5 h-5 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 20 20"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  <section class="py-14 lg:py-24 ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="md:gap-x-8 grid grid-cols-1 sm:grid-cols-2 w-full">
        <div class="group w-full flex-wrap flex items-center gap-8  transition-all duration-500 p-8  lg:flex-nowrap">
          <div class=" w-full lg:w-48 h-64">
            <img src="https://pagedone.io/asset/uploads/1696238786.png" alt="Harsh image"
          ...
          <div class="text-center lg:text-left lg:max-w-xs flex-1">
            ...
            <div class="flex items-center gap-4 justify-center lg:justify-start">
              <a href="javascript:;"
                class="cursor-pointer w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 group-hover:bg-indigo-600">
        ...
        <div
          ...
          <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
            <img src="https://pagedone.io/asset/uploads/1696238869.png" alt="Alexa image"
              class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full"/>
          </div>
      ...
      <div class="mt-16 text-center relative w-fit mx-auto flex items-start gap-8">
        <a href="javascript:;" class="cursor-pointer relative md:-left-14 md:-top-1 left-12 top-6">
          <svg class="w-4 h-3 text-gray-900 hover:text-indigo-600" viewBox="0 0 17 12" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
              d="M15.5019 6L2.16856 6M6.33522 1L1.92448 5.41074C1.6467 5.68852 1.50781 5.82741 1.50781 6C1.50781 6.17259 1.6467 6.31148 1.92448 6.58926L6.33522 11"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </a>
       
        <div class="">
          <div class="slider-scrollbar w-72 h-[2px] mx-auto bg-gray-100 relative rounded-full mb-4">
            <div class="absolute w-24 h-[2px] bg-indigo-600"></div>
          </div>
          <div class="slider-count text-lg text-gray-900">
            1 <span class="text-gray-400">/ 20</span>
          </div>
        </div>
        <a href="javascript:;" class="cursor-pointer relative md:-right-14 md:-top-1 right-12 top-6">
          <svg class="w-4 h-3 text-gray-900 hover:text-indigo-600" viewBox="0 0 17 12" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
