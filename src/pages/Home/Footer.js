            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div style={{width:'100%'}}>
                    ...
                    <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li><a href="#" class="text-gray-800 hover:text-gray-900">About us</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">Contact us</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">Portfolio</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">Blogs</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">Services</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">Rating</a></li>
                    </ul>
                    ...
                    <span class="text-lg text-gray-500 text-center block">©Artizz DEV 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
