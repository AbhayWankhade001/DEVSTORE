  ...
  return (
    <div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-24">
                <h2 class="font-manrope text-5xl text-center font-bold text-white mb-4">Suitable pricing plans</h2>
                <p class="text-gray-300 text-xl text-center leading-6">7 Days free trial. No credit card required.</p>
             
            </div>
                <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-md transition-all duration-300  p-8 xl:p-12  ">
                        ...
                        <h3 class="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Free Plan</h3>
                        <div class="flex items-center justify-center">
                            <span class="font-manrope text-4xl font-medium text-gray-900">$0</span>
                        ...
                        <a href="#" class="py-4 px-8 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-lg text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</a>
                    </div> 
                    <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-md transition-all duration-300  p-8 xl:p-12  ">
                        <div class="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div class="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                        
                                <svg class="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Business Plan</h3>
                        <div class="flex items-center justify-center">
                  ...
                  <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-md transition-all duration-300  p-8 xl:p-12  ">
                    ...
                    <h3 class="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Enterprise Plan</h3>
                    <div class="flex items-center justify-center">
