...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://devstore-backend.vercel.app/api/theUserregister', {
                method: 'POST',
                headers: {
    ...
    return (
        <motion.div
            ...
            <section class="py-24" style={{ marginTop: "200px" }}>
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
                        <div class="flex items-center justify-center lg:mb-0 mb-10">
                            <div class="">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <input type="text"
                                        name="name"
                                        value={formData.name}
                                        onChange={handleChange} class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8" placeholder="Name" />
                                    <input type="email"
                                        name="email"
                                        value={formData.email}
                                        onChange={handleChange} class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8" placeholder="Email" />
                                    <textarea name="message"
                                        value={formData.message} maxLength="500"
                                        onChange={handleChange} class="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-8" placeholder="Phone"></textarea>
                                     <div className="text-gray-600 text-sm mb-4">
                                        {remainingChars >= 0 ? `${remainingChars} characters remaining` : 'Character limit exceeded'}
                                    </div>
                                    <button   type="submit" class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#ffb923] shadow transition-all duration-700 hover:bg-indigo-800">Submit</button>
                                </form>
                            </div>
                        </div>
                        <div class="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat " style={{ backgroundImage: `url(${Bg})` }}>
                            <div class="">
                                <div class="lg:w-96 w-auto h-auto rounded-3xl bg-white shadow-xl lg:p-6 p-4">
                                    <div style={{ width: '100%' }}>
                                        <div style={{
                                        ...
                                        >
                                            ...
                                            <h1 className='text-4xl font-semibold leading-10 py-0 lg:text-left text-center'>rtizz</h1>
                                        </div>
                                    ...
                                    <a href="javascript:;" class="flex items-center mb-6">
                                        ...
                                        <h5 class="text-black text-base font-normal leading-6 ml-5">+919322066516</h5>
                                    </a>
                                    <a href="javascript:;" class="flex items-center mb-6">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h5 class="text-black text-base font-normal leading-6 ml-5">official@artizz.in</h5>
                                    </a>
                                    <a href="javascript:;" class="flex items-center mb-6">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h5 class="text-black text-base font-normal leading-6 ml-5">Gayatri Nagar Khaulkhade Rd Akola 444004</h5>
                                    </a>
